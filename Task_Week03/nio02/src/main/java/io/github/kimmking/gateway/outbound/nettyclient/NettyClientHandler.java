...
import io.github.kimmking.gateway.outbound.nettyclient.Attributes;
...
public class NettyClientHandler extends SimpleChannelInboundHandler<FullHttpResponse> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpResponse msg) throws Exception {
        ...
        ChannelHandlerContext serverChannel = clientChannel.attr(Attributes.SERVER_CHANNEL).get();
        FullHttpResponse response = msg;

//        String value = "HHHHHHI!";
